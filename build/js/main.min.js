...
var _formSelect = require("./modules/form-select");
...
},{"./modules/form-select":2,"./modules/form-validate/form":4,"./modules/leaflet":10,"./modules/mobile-menu":11,"./modules/modals/init-modals":12,"./modules/my-swipers":14,"./utils/ios-vh-fix":17,"./vendor/init-accordion":20,"./vendor/init-tabs":21}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initFormSelects = initFormSelects;
...
function initFormSelect(customSelect) {
  ...
  var selectBtnLabel = selectBtn.querySelector('span');
  var selectBtnInput = selectBtn.previousElementSibling;
  var optionsList = customSelect.querySelector('ul');
  var optionsListItems = optionsList.querySelectorAll('li');
  var clickOutsideListener;
  function toggleList() {
    var nextIsActive = !customSelect.classList.contains('active');

    // add/remove active class on the container element
    customSelect.classList.toggle('active', nextIsActive);
    // update the aria-expanded attribute based on the current state
    selectBtn.setAttribute('aria-expanded', "".concat(nextIsActive));
    if (nextIsActive) {
  ...
  function addOutsideClickListener() {
    clickOutsideListener = setTimeout(function () {
...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function reset(form) {
      ...
      form.querySelectorAll('button[type="button"] span').forEach(function (item) {
        item.innerText = '';
      });
      setTimeout(function () {
...
},{"../vendor/swiper.js":22}],15:[function(require,module,exports){
"use strict";
...
},{"./tabs":23}],22:[function(require,module,exports){
