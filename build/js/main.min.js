...
},{"./modules/form-select":2,"./modules/form-validate/form":4,"./modules/leaflet":10,"./modules/mobile-menu":11,"./modules/modals/init-modals":12,"./modules/modals/modal-form-select":13,"./modules/my-swipers":15,"./utils/ios-vh-fix":18,"./vendor/init-accordion":21,"./vendor/init-tabs":22}],2:[function(require,module,exports){
"use strict";

var customSelect = document.querySelector(".custom-select");
var selectLabel = customSelect.querySelector("p");
var selectBtn = customSelect.querySelector("button");
var selectedValue = customSelect.querySelector("span");
var optionsList = customSelect.querySelectorAll("ul li");
...
var menuToggleButton = document.querySelector(".header__menu-button");
var pageWrapper = document.querySelector(".page-wrapper");
var mainPage = document.querySelector("main");
var menuLogo = document.querySelector(".header__logo");
var menuButtonWrapper = document.querySelector(".header__menu-wraper");
var menuWrapper = document.querySelector(".header__nav");
var menuLinks = Array.from(document.querySelectorAll(".header__menu-link"));
var menuExpandedLinks = Array.from(document.querySelectorAll(".header__menu-expanded-link"));
var toggleMenuStyles = function toggleMenuStyles() {
  ...
  menuExpandedLinks.forEach(function (link) {
...
var menuInnerLinksHandler = function menuInnerLinksHandler(evt) {
  console.log("hi");
  evt.preventDefault;
...
var customSelectModal = document.querySelector(".custom-select-modal");
var selectLabel = customSelectModal.querySelector("p");
var selectBtn = customSelectModal.querySelector("button");
var selectedValue = customSelectModal.querySelector("span");
var optionsList = customSelectModal.querySelectorAll("ul li");
function selectListToggle() {
  // add/remove active class on the container element
  ...
  new _swiper.default(".swiper-hero", {
    ...
    pagination: {
      ...
      renderBullet: function renderBullet(index, className) {
        return '<span class="' + className + ' pagination-bullet--hero">' + "</span>";
      }
    },
    breakpoints: {
      1200: {
...
var initNewsSwiper = function initNewsSwiper() {
  // eslint-disable-next-line no-new
  new _swiper.default(".swiper-news", {
    loop: false,
    ...
    pagination: {
      ...
      clickable: true,
      renderBullet: function renderBullet(index, className) {
        return '<span class="' + className + ' pagination-bullet--news">' + (index + 1) + "</span>";
      }
    },
    navigation: {
...
var initProgramsSwiper = function initProgramsSwiper() {
  // eslint-disable-next-line no-new
  new _swiper.default(".swiper-programs", {
    direction: "horizontal",
    loop: false,
    slidesPerView: 1,
    spaceBetween: 15,
...
},{"../vendor/swiper.js":23}],16:[function(require,module,exports){
"use strict";
